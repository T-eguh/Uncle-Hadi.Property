...
import { Building, Phone, Mail, MapPin, Facebook, Instagram, Send, Video } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4" id="footer-brand-section">
            ...
            <p className="text-sm text-[#F8FAFC]/70 leading-relaxed">
              Membantu Anda menemukan property yang tepat untuk hunian maupun investasi jangka panjang di Bekasi, Jakarta Timur, Cikarang, dan sekitarnya dengan jujur, transparan, dan terpercaya.
            </p>
          ...
          <div id="footer-contact-section">
            ...
            <ul className="space-y-4 text-sm text-[#F8FAFC]/75">
              <li className="flex items-start">
                ...
                <span>Bekasi Timur, Bekasi, Jawa Barat (Samping Stasiun KRL Bekasi Timur)</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-[#D4A017] mr-3 shrink-0" />
                <a href="https://wa.me/628123456789" target="_blank" rel="noopener noreferrer" className="hover:text-[#D4A017] transition">
                  +62 812-3456-7890
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-[#D4A017] mr-3 shrink-0" />
                <a href="mailto:hadi@unclehadi.property" className="hover:text-[#D4A017] transition">
                  hadi@unclehadi.property
                </a>
              </li>
            </ul>
          </div>
